...
class UserServiceImplIntegrationTest {
    ...
    void createUser() {
        firstUser.setId(1L);
        Assertions.assertEquals(UserMapper.mapToDto(firstUser),
    ...
    void updateUser() {
        ...
        Assertions.assertEquals(UserMapper.mapToDto(firstSavedUser),
                userService.updateUser(UserMapper.mapToDto(userUpdate)));
    }
